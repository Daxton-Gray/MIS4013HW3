    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          ...
          <div class="mb-3">
            <label for="league_abbreviation" class="form-label">League Abbreviation</label>
            <input type="text" class="form-control" id="league_abbreviation" name="league_abbreviation">
          </div>
          <div class="mb-3">

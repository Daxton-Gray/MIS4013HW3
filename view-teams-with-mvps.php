...
?>
    <li class="list-group-item">
      <?php echo $mvp['f_name']; ?> <?php echo $mvp['l_name']; ?>
      <br/><?php echo $mvp['position']; ?>
      <br/><?php echo $mvp['seasons_with_team']; ?> Seasons - <?php echo $mvp['mvp_seasons']; ?> MVPs
      <br/><?php include "view-mvps-editform.php"; ?>

...
if (isset($_POST['actionType'])) {
  switch ($_POST['actionType']) {
    case "Add":
      if (insertMVP($_POST['tid'], $_POST['f_name'], $_POST['l_name'], $_POST['position'], $_POST['seasons_with_team'], $_POST['mvp_seasons'])) {
      ...
      break;
    case "Edit":
      if (updateMVP($_POST['tid'], $_POST['f_name'], $_POST['l_name'], $_POST['position'], $_POST['seasons_with_team'], $_POST['mvp_seasons'], $_POST['mvpid'])) {
